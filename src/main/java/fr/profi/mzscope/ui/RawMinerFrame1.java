 ...
 * @author CB205360
 */
public class RawMinerFrame1 extends javax.swing.JFrame implements RawFileListener{

   final private static Logger logger = LoggerFactory.getLogger(RawMinerFrame1.class);
    ...
    */
   public RawMinerFrame1() {
      initComponents();
      //rawFilesPanel1.setParentFrame(this);
      rawFilesPanel1.addRawFileListener(this);
   }
            ...
            protected void done() {
                try {
                  ...
                  for (int i = 0; i < featuresTabPane.getComponentCount(); i++) {
                   ...
                   logger.error("Error while reading chromatogram "+e);
                }
             }
          };
          worker.execute();
...
//         javax.swing.UIManager.setLookAndFeel("com.jtattoo.plaf.fast.FastLookAndFeel");
         ...
         java.util.logging.Logger.getLogger(RawMinerFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      java.awt.EventQueue.invokeLater(new Runnable() {
         public void run() {
            new RawMinerFrame1().setVisible(true);
         }
      });
   }
    ...
    public void extractFeatures(IRawFile rawfile) {
        extractFeaturesMIActionPerformed(null);
    }
    ...
    public void detectPeakels(IRawFile rawfile) {
        detectPeakelsMIActionPerformed(null);
    }
    ...
    public void exportChromatogram(IRawFile rawfile) {
        exportChromatogramActionPerformed(null);
    }
